...
AI was used to help generate some of the documentation for this project,
to brainstorm some ideas on how to implement certain functions and explain complex concepts.
However, all code submitted is my own work and was not generated by AI.